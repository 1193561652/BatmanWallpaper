...
public class VertexManager {
	...
	public DirectionalVertex buildAndRegisterVertex(FaceProperty faceProperty) {
		...
		if(vertex == null) {
			...
			vertex = new DirectionalVertex(this.currentVertexID++, this.getVertexAt(vertexID), this.getNormalAt(normalID), this.getTextureCoordinatesAt(textureCoordinateID));
