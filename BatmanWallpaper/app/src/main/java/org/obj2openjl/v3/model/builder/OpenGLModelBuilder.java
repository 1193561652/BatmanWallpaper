...
public class OpenGLModelBuilder {
	...
	public RawOpenGLModel buildOpenGLModel(List<Vertex> vertices, List<Normal> normals, List<TexturePoint> texturePoints, List<List<FaceProperty>> faceProperties, List<String> usemtl) {
		...
		return new RawOpenGLModel(faceBuilder.getFaces(), faceBuilder.vertexManager.getVertexBoundingBox(), vertices, usemtl);
	}
	...
	private static class FaceBuilder {
		...
		public FaceBuilder(List<Vertex> vertices, List<Normal> normals, List<TexturePoint> texturePoints) {
